	...
	<div class="dashboard-tab register">
		...
		<div class="col mfn-ui">
			<form method="post" class="mfn-form">
				...
				<h3 class="primary"><?php __('Built-in features', 'becstm'); ?></h3>
				...
				<?php
					Mfn_Builder_Admin::field( array(
						'id' => 'disable_single_import',
						'type' => 'switch',
						'title' => $this->get_attributes['disable_single_import']['title'],
						'options' => array(
							0 => 'Visible',
							1 => 'Hidden'
						),
						'std' => '0',
						'desc' => $this->popup('disable_single_import')
					), $this->options['disable_single_import']['value'] ? 1 : 0, $meta)
				?>
				...
				<?php submit_button( __('Save changes', 'becstm') );  ?>
			</form>
		</div>
	</div>
