...
<?php if( WHITE_LABEL ): ?>
	<h1><?php echo __( 'Welcome to WordPress', 'becstm' ); ?></h1>
<?php else: ?>
	<h1><?php echo __( 'Welcome to BeCustom', 'becstm' ); ?></h1>
<?php endif; ?>

<p class="about-text">
	<?php echo __( 'Here you can customize our theme, even more!', 'becstm' ); ?>
</p>
...
<h2 class="nav-tab-wrapper wp-clearfix">
	<a href="admin.php?page=be_custom" class="nav-tab<?php if( $current_screen == strtolower($betheme_label).'_page_be_custom' ) echo ' nav-tab-active'; ?>"><?php echo __( 'General', 'becstm' ); ?></a>
	<a href="admin.php?page=be_custom_branding" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_branding' ) echo ' nav-tab-active'; ?>"><?php echo __( 'Branding' , 'becstm' ); ?></a>
	<a href="admin.php?page=be_custom_built_in_features" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_built_in_features' ) echo ' nav-tab-active'; ?>"><?php echo __( 'Built-in features', 'becstm' ); ?></a>
	<a href="admin.php?page=be_custom_wp_login" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_wp_login' ) echo ' nav-tab-active'; ?>"><?php echo __( 'WP Login', 'becstm' ); ?></a>
	<a href="admin.php?page=be_custom_be_dashboard" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_be_dashboard' ) echo ' nav-tab-active'; ?>"><?php echo __( 'Be dashboard', 'becstm' ); ?></a>
	<a href="admin.php?page=be_custom_advanced" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_advanced' ) echo ' nav-tab-active'; ?>"><?php echo __( 'Advanced', 'becstm' ); ?></a>
</h2>
